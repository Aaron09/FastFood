...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ReviewAdapter.ViewHolder holder, int position) {
        ...
        holder.voteTotalTextView.setText(Long.toString(review.getVoteTotal()));
        ...
        databaseReference.child(Review.UPVOTES).addChildEventListener(
                new FirebaseVoteListener(review, Review.UPVOTES,
                holder.voteTotalTextView, context));

        // listener for firebase downvote changes
        databaseReference.child(Review.DOWNVOTES).addChildEventListener(
                new FirebaseVoteListener(review, Review.DOWNVOTES,
                holder.voteTotalTextView, context));
